...
SpeedMultiplier = 0.25;
  ...
  driveTrain.CycleDrive((controller.getRawAxis(Constants.XBOX_RIGHT_X_AXIS)*(Constants.DRIVETRAINSPEED)*DirectionMultiplier), (-1)*(controller.getRawAxis(Constants.XBOX_LEFT_Y_AXIS)*(Constants.TURNSPEED)));
    }
